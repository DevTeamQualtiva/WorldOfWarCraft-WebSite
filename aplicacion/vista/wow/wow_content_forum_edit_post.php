        ...
        <div class="talkback new-post">
          ...
          <form method="post" onsubmit="return Cms.Topic.postValidate(this);" action="#new-post">
            <div>
              ...
              <input type="hidden" name="sessionPersist" value="forum.topic.post.edit" />
              <div class="post general">
                <div class="post-user-details ">
                  <h4><?php echo WoW_Locale::GetString('template_forum_post_edit_title'); ?></h4>
...
?>
                ...
                <div class="post-edit">
                  ...
                  <div class="editor1" id="post-edit" style="display: block; ">
                    <div class="bml-toolbar">
                    </div>
                    <a id="editorMax" rel="5000"></a>  
<textarea id="postCommand.detail" name="postCommand.detail" class="post-editor" cols="78" rows="13"><?php echo WoW_Template::GetPageData('edit_text'); ?></textarea> 
...
//]]>
                  ...
                  <div class="post-detail" id="post-preview" style="display: none; "><?php echo WoW_Template::GetPageData('edit_text'); ?></div> 
          ...
          <div class="talkback-code">
            <div class="talkback-code-interior">
              <div class="talkback-icon">
                ...
                <p>Posts containing personal information about other players. <strong>This aplicacion physical addresses, e-mail addresses, phone numbers, and inappropriate photos and/or videos.</strong></p>
