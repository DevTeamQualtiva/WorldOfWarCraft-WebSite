			...
			<div id="station-content">
				<div class="station-content-wrapper">
					...
					<div class="right-column">
						...
						<div class="coc"> 
							<?php echo WoW_Locale::GetString('template_forums_forum_rules'); ?>
							<a href="<?php echo WoW::GetWoWPath(); ?>/community/conduct"><?php echo WoW_Locale::GetString('template_forums_forum_rules2'); ?></a>
							<?php echo WoW_Locale::GetString('template_forums_forum_rules3'); ?>
						</div>
					<span class="clear"><!-- --></span>
					</div>
				</div>
