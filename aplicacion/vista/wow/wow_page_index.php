...
?>
<script type="text/javascript" src="<?php echo WoW::GetWoWPath(); ?>/wow/static/local-common/js/menu.js"></script>
...
<!--[if lt IE 8]> <script type="text/javascript" src="<?php echo WoW::GetWoWPath(); ?>/wow/static/local-common/js/third-party/jquery.pngFix.pack.js"></script>
...
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/character/achievement.js?v7"></script>';
    ...
    case 'character_feed':
        ...
        break;
    case 'item':
        echo '<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/wiki/wiki.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/wiki/item.js"></script>
...
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/character/statistic.js?v7"></script>';
    ...
    case 'character_companions_mounts':
        echo '<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/profile.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/character/companion.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/filter.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/utility/dataset.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/utility/model-rotator.js"></script>';
        break;
    case 'blog':
        echo '<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/lightbox.js"></script>';
        break;
    case 'auction_lots':
        echo '<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/profile.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/character/auction.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/table.js"></script>';
        break;
    case 'forum_index':
        echo '<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/cms.js"></script>';
        break;
    case 'zones':
        echo '<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/wiki/wiki.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/filter.js"></script>';
    ...
    case 'zone':
        echo '<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/wiki/wiki.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/wiki/zone.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/table.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/cms.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/filter.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/lightbox.js"></script>';
        break;
    case 'game_guide_what_is_wow':
    case 'game_guide_getting_started':
    case 'game_guide_how_to_play':
...
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/filter.js"></script>';
        break;
    case 'pvp_arena':
        echo '<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/utility/dynamic-menu.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/pvp/pvp.js"></script>';
        break;
    case 'pvp_arena_ladder':
        echo '<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/utility/dynamic-menu.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/pvp/ladder.js"></script>';
        break;
    case 'boss':
        echo '<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/wiki/wiki.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/js/wiki/npc.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/utility/model-rotator.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/table.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/cms.js"></script>
<script type="text/javascript" src="' . WoW::GetWoWPath() . '/wow/static/local-common/js/filter.js"></script>
...
<script type="text/javascript">
//<![CDATA[
    Core.load("<?php echo WoW::GetWoWPath(); ?>/wow/static/local-common/js/overlay.js");
    Core.load("<?php echo WoW::GetWoWPath(); ?>/wow/static/local-common/js/search.js");
    Core.load("<?php echo WoW::GetWoWPath(); ?>/wow/static/local-common/js/third-party/jquery-ui-1.8.6.custom.min.js");
    Core.load("<?php echo WoW::GetWoWPath(); ?>/wow/static/local-common/js/third-party/jquery.mousewheel.min.js");
    Core.load("<?php echo WoW::GetWoWPath(); ?>/wow/static/local-common/js/third-party/jquery.tinyscrollbar.min.js");
    Core.load("<?php echo WoW::GetWoWPath(); ?>/wow/static/local-common/js/login.js", false, function() {
